...
- **Milestone 2 — no s·pᵃ·qᵇ for all a, b ≥ 1.** Two-parameter class family with p²- and q²-telescoping; every Milestone-1 kill restated generically in the exponents; double induction with the uniform theorem as the base row and column. Closes two useful primes entirely.
