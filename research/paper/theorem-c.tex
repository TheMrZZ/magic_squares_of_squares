...
the obstruction survives every first-order $p$-adic tool.  Resolving the
residue requires second-order lifts along the $\pi$-power orbit, or remains
a per-$(j,\Delta)$ finite check; it is the precise uniform incarnation of
the divisibility-coincidence ladder behind Bremner's near-miss.
